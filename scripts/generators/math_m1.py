...
def _pythagoras():
    ...
    return {"question": q, "options": opts, "answer": ai, "answerKey": chr(65 + ai), "explanation": expl, "difficulty": "Medio"}
...
def _proportion():
    ...
    opts, ai = shuffle_mcq(str(x), wrong)
    return {"question": f"{a} obreros en {b} dias. {c} obreros tardan?", "options": [f"{o} dias" for o in opts],
            "answer": ai, "answerKey": chr(65 + ai), "explanation": f"x={x}", "difficulty": "Medio"}
